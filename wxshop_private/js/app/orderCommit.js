...
var app = {
  ...
  check: function() {
   ...
   wechatapi.dialog.confirm("烦请先登录，再进行下单", function() {
     window.location.href = 'userInfo.html?cId=' + cId + '&fromPage=orderCommit';
   });
...
//  }
    ...
    var salesId = app.userInfo.employeeId?app.userInfo.employeeId:1;
    var invoiceId = app.invoice?app.invoice.id:null;
...
//  };
    ...
    var param = {
      ...
      "orderType": 2, //1销售下单 2客户下单
      "salesId":salesId, // 销售id 
