const ERR_OK = 100000;
var CNANNEL = 4; //渠道：1线下 2线上 3 app 4 publicStore 5 privateStore 
var CATEGORYID = 47; //categoryId 麦卡伦分类id
var wechatapi = (function() {
  return {
    ...
    wxAPI: {
      share: function(urlParam, imgUrl, title, desc) {
        wechat.init_jssdk(function() {
          wx.ready(function() {
            wx.onMenuShareTimeline({
              title: title, // 分享标题
              link: urlParam, // 分享链接，该链接域名必须与当前企业的可信域名一致
              imgUrl: imgUrl, // 分享图标
              success: function() {
                // 用户确认分享后执行的回调函数
              },
