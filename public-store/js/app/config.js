...
//gateway: 'https://edrington.shop/api', // 生产域名
//pathname: '/public-store/html/',  //生产文件路径

gateway: 'http://dtc.ocheng.me/api', // 测试域名
pathname: '/h5/public-store/html/', //测试文件路径
  ...
  brandList: '/product/productInfo/brand/list', //品牌接口
