    ...
    return {
        ...
        get_auth: function (companyId, callback) {
            this.post_data("/api/wechat/web/auth", {
                url: "http://dtc.ocheng.me/h5/wxshop_private_order/html/orderActivity.html?cId="+cId,
            ...
            this.post_data(API.gateway+"wechat/web/get/jssdk", {
              ...
              if(data.code == 100000){
                ...
                wx.config({
                  ...
                  jsApiList: ['hideAllNonBaseMenuItem','getLocation','onMenuShareTimeline', 'onMenuShareAppMessage', 'chooseImage', 'previewImage', 'uploadImage', 'downloadImage']
                });
                call_back && call_back();
              }else{
